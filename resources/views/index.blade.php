...
<body>
    ...
    <!--product--------------------->
            ...
            <div class="phantrang" style="max-width: 170px; height: 100px; position: relative;top: 50%;left: 50% ;transform: translate(-50%, -50%);margin-top: 50px">
                {!! $products -> links()!!}
            </div>
                </div>
            @endisset
    ...
    <!--product--------------------->
            ...
            <div class="row featured__filter">
                ...
                @endforeach
                <div style="max-width: 170px; height: 100px; position: relative;top: 50%;left: 50% ;transform: translate(-50%, -50%);margin-top: 50px">
                    {!! $timkiem -> links()!!}
                </div>
            </div>
            @endisset
